...
impl<'a> PriceLevel<'a> {
    ...
    pub fn price(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(PriceLevel::VT_PRICE, Some(0.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn size(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(PriceLevel::VT_SIZE, Some(0.0))
                .unwrap()
        }
    }
}
...
impl PriceLevelT {
    pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
        ...
        let price = self.price;
        let size = self.size;
        PriceLevel::create(_fbb, &PriceLevelArgs { price, size })
    }
}
...
impl<'a> OrderBook<'a> {
    ...
    pub const VT_EXCH_TIMESTAMP: flatbuffers::VOffsetT = 10;
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
        ...
        builder.add_exch_timestamp(args.exch_timestamp);
    ...
    pub fn unpack(&self) -> OrderBookT {
        let topic = self.topic().map(|x| x.to_string());
        let bids = self.bids().map(|x| x.iter().map(|t| t.unpack()).collect());
        let asks = self.asks().map(|x| x.iter().map(|t| t.unpack()).collect());
        let exch_timestamp = self.exch_timestamp();
        OrderBookT {
            topic,
            bids,
            asks,
    ...
    pub fn topic(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(OrderBook::VT_TOPIC, None)
        }
    }
    #[inline]
    pub fn bids(
        &self,
    ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PriceLevel<'a>>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PriceLevel>>,
    ...
    #[inline]
    pub fn exch_timestamp(&self) -> u64 {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<u64>(OrderBook::VT_EXCH_TIMESTAMP, Some(0))
                .unwrap()
        }
    }
}
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<PriceLevel>>,
            >>("bids", Self::VT_BIDS, false)?
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<PriceLevel>>,
            >>("asks", Self::VT_ASKS, false)?
            .visit_field::<u64>("exch_timestamp", Self::VT_EXCH_TIMESTAMP, false)?
            .finish();
        Ok(())
    }
}
pub struct OrderBookArgs<'a> {
    ...
    pub bids: Option<
        flatbuffers::WIPOffset<
            flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PriceLevel<'a>>>,
        >,
    >,
    pub asks: Option<
        flatbuffers::WIPOffset<
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> OrderBookBuilder<'a, 'b, A> {
    ...
    pub fn add_topic(&mut self, topic: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(OrderBook::VT_TOPIC, topic);
    }
    #[inline]
    pub fn add_bids(
        &mut self,
        bids: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<PriceLevel<'b>>>,
        >,
    ) {
        self.fbb_
    ...
    #[inline]
    pub fn add_exch_timestamp(&mut self, exch_timestamp: u64) {
        self.fbb_
            .push_slot::<u64>(OrderBook::VT_EXCH_TIMESTAMP, exch_timestamp, 0);
    }
    #[inline]
...
impl core::fmt::Debug for OrderBook<'_> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        ...
        ds.field("exch_timestamp", &self.exch_timestamp());
        ds.finish()
    }
}
#[non_exhaustive]
...
impl OrderBookT {
    pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
        ...
        let topic = self.topic.as_ref().map(|x| _fbb.create_string(x));
...
pub fn size_prefixed_root_as_order_book(
    buf: &[u8],
) -> Result<OrderBook, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_order_book_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    root: flatbuffers::WIPOffset<OrderBook<'a>>,
) {
